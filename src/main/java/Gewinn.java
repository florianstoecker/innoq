            ...
            for (int j = 0; j < 7; j++)
            {
                if (Spielfeld[i][j] == zeichen_spieler)
                {
                    ...
                    else if (i > 2)
                    {
                        ...
                        if (j < 3) //diagonal
                        {
                            if (Spielfeld[i - 1][j + 1] == zeichen_spieler && Spielfeld[i - 1][j + 2] == zeichen_spieler && Spielfeld[i - 1][j + 3] == zeichen_spieler)
                            {
                                erg = true;
                                return erg;
                            }
                        ...
                        else if (j == 3) //diagonal
                        {
                            ...
                            else if (Spielfeld[i - 1][j - 1] == zeichen_spieler && Spielfeld[i - 1][j - 2] == zeichen_spieler && Spielfeld[i - 1][j - 3] == zeichen_spieler)
                            {
                                erg = true;
                                return erg;
                            }
